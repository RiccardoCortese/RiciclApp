...
\begin{itemize}
    \item Repository GitHub: \href{https://github.com/RiccardoCortese/RiciclApp/tree/main }{link} 
    \item Swagger:\href{https://app.swaggerhub.com/apis/uni-01b-515/RiciclApp/1.0.0}{link} 

    In alternativa nella cartella github è presente \textit{Docs/Architettura/openapi.yaml}
